...
# Ported from NVIDIA DreamZero: groot/vla/model/dreamzero/modules/wan_video_image_encoder.py
...
# Inlined from groot/vla/model/dreamzero/modules/wan_video_dit.py
try:
